...
echo Building fase19_shader_workspace_ui_tests...
cl.exe /MT /std:c++20 /Od /EHsc /bigobj /F33554432 ^
  ...
  src\native\fase19_test_unity.cpp ^
  src\native\renderer_vk\library\tests\fase19_shader_workspace_ui_tests_main.cpp ^
  /Febuild\fase19_shader_workspace_ui_tests.exe
