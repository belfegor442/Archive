...
constexpr int kModernThemeMode = 5;
...
struct ThemePalette {
  ...
  COLORREF sidebarHighlight;
  COLORREF statusBarBg;
  COLORREF statusBarText;
  COLORREF chartBg;
  COLORREF chartGrid;
  COLORREF panelGlow;
  COLORREF activeRowGlow;
  COLORREF activeText;
  COLORREF healthOk;
  COLORREF healthWarn;
  COLORREF healthCrit;
  ...
  bool useVignette;
  bool useBezel;
  bool useRoundedPanels;
};

static constexpr ThemePalette kGreenCRTPalette {
  RGB(1, 6, 2),       // black
  RGB(2, 14, 4),      // panel
  RGB(4, 20, 6),      // panelSoft
  RGB(1, 10, 2),      // panelDeep
  RGB(140, 255, 112), // green
  RGB(180, 255, 150), // greenBright
  RGB(84, 184, 74),   // green2
  RGB(48, 119, 43),   // green3
  RGB(24, 74, 25),    // green4
  RGB(14, 48, 16),    // green5
  RGB(8, 64, 18),     // glow
  RGB(4, 36, 10),     // glowSoft
  RGB(18, 18, 20),    // bezel
  RGB(30, 30, 34),    // bezelEdge
  RGB(8, 8, 10),      // bezelInner
  RGB(230, 210, 76),  // warn
  RGB(255, 92, 74),   // error
  RGB(116, 248, 93),  // accent
  RGB(140, 255, 112), // textPrimary
  RGB(84, 184, 74),   // textSecondary
  RGB(48, 119, 43),   // textDim
  RGB(2, 14, 4),      // headerBg
  RGB(140, 255, 112), // headerText
  RGB(1, 10, 2),      // sidebarBg
  RGB(84, 184, 74),   // sidebarText
  RGB(140, 255, 112), // sidebarHighlight
  RGB(2, 14, 4),      // statusBarBg
  RGB(48, 119, 43),   // statusBarText
  RGB(1, 8, 2),       // chartBg
  RGB(14, 48, 16),    // chartGrid
  RGB(0, 18, 4),      // panelGlow
  RGB(0, 40, 8),      // activeRowGlow
  RGB(1, 12, 2),      // activeText
  RGB(4, 18, 6),      // healthOk
  RGB(24, 22, 4),     // healthWarn
  RGB(24, 6, 4),      // healthCrit
  true,                // useGlow
  true,                // useScanlines
  true,                // useVignette
  true,                // useBezel
  false,               // useRoundedPanels
};

static constexpr ThemePalette kWin98Palette {
  RGB(0, 0, 0),       // black
  RGB(192, 192, 192), // panel
  RGB(212, 212, 212), // panelSoft
  RGB(128, 128, 128), // panelDeep
  RGB(0, 0, 0),       // green (text primary for Win98)
  RGB(0, 0, 128),     // greenBright (title bar blue)
  RGB(128, 128, 128), // green2
  RGB(192, 192, 192), // green3
  RGB(128, 128, 128), // green4
  RGB(192, 192, 192), // green5
  RGB(0, 0, 0),       // glow
  RGB(0, 0, 0),       // glowSoft
  RGB(192, 192, 192), // bezel
  RGB(255, 255, 255), // bezelEdge
  RGB(128, 128, 128), // bezelInner
  RGB(255, 255, 0),   // warn
  RGB(255, 0, 0),     // error
  RGB(0, 0, 255),     // accent
  RGB(0, 0, 0),       // textPrimary
  RGB(0, 0, 0),       // textSecondary
  RGB(128, 128, 128), // textDim
  RGB(0, 0, 128),     // headerBg
  RGB(255, 255, 255), // headerText
  RGB(192, 192, 192), // sidebarBg
  RGB(0, 0, 0),       // sidebarText
  RGB(0, 0, 128),     // sidebarHighlight
  RGB(192, 192, 192), // statusBarBg
  RGB(0, 0, 0),       // statusBarText
  RGB(255, 255, 255), // chartBg
  RGB(192, 192, 192), // chartGrid
  RGB(0, 0, 0),       // panelGlow
  RGB(0, 0, 128),     // activeRowGlow
  RGB(255, 255, 255), // activeText
  RGB(0, 128, 0),     // healthOk
  RGB(255, 165, 0),   // healthWarn
  RGB(255, 0, 0),     // healthCrit
  false,               // useGlow
  false,               // useScanlines
  false,               // useVignette
  true,                // useBezel
...
static constexpr ThemePalette kModernPalette {
  RGB(18, 18, 24),    // black
  RGB(28, 28, 36),    // panel
  RGB(38, 38, 48),    // panelSoft
  RGB(12, 12, 16),    // panelDeep
  RGB(99, 179, 237),  // green (blue accent)
  RGB(129, 199, 245), // greenBright
  RGB(74, 144, 217),  // green2
  RGB(54, 109, 167),  // green3
  RGB(34, 74, 117),   // green4
  RGB(20, 48, 74),    // green5
  RGB(99, 179, 237),  // glow
  RGB(54, 109, 167),  // glowSoft
  RGB(44, 44, 56),    // bezel
  RGB(64, 64, 80),    // bezelEdge
  RGB(24, 24, 32),    // bezelInner
  RGB(255, 193, 7),   // warn
  RGB(244, 67, 54),   // error
  RGB(156, 39, 176),  // accent
  RGB(224, 224, 232), // textPrimary
  RGB(158, 158, 172), // textSecondary
  RGB(96, 96, 112),   // textDim
  RGB(28, 28, 36),    // headerBg
  RGB(224, 224, 232), // headerText
  RGB(18, 18, 24),    // sidebarBg
  RGB(158, 158, 172), // sidebarText
  RGB(99, 179, 237),  // sidebarHighlight
  RGB(28, 28, 36),    // statusBarBg
  RGB(96, 96, 112),   // statusBarText
  RGB(12, 12, 16),    // chartBg
  RGB(38, 38, 48),    // chartGrid
  RGB(99, 179, 237),  // panelGlow
  RGB(54, 109, 167),  // activeRowGlow
  RGB(18, 18, 24),    // activeText
  RGB(76, 175, 80),   // healthOk
  RGB(255, 193, 7),   // healthWarn
  RGB(244, 67, 54),   // healthCrit
  true,                // useGlow
  false,               // useScanlines
  false,               // useVignette
  true,                // useBezel
  true,                // useRoundedPanels
};

static const ThemePalette& GetPalette(int themeMode) {
  switch (themeMode) {
    case kWin98ThemeMode: return kWin98Palette;
    case kModernThemeMode: return kModernPalette;
    default: return kGreenCRTPalette;
  }
}
...
class CoreMonitorTheme {
 public:
  ...
  static void Render(HDC dc, const RECT& clientRect, const CoreMonitorThemeContext& ctx) {
    const Canvas canvas = MakeCanvas(clientRect, ctx.config.themeMode);
    s_pal = canvas.pal;
    Fill(dc, clientRect, RGB(0, 0, 0));
    Fill(dc, canvas.rect, s_pal->black);
  ...
  static bool HitTestMenu(const RECT& clientRect, POINT point, int& menuIndex) {
    const Canvas canvas = MakeCanvas(clientRect, 3);
 ...
 private:
  ...
  static inline const ThemePalette* s_pal = &kGreenCRTPalette;

  struct Canvas {
    RECT rect {};
    double scale = 1.0;
    const ThemePalette* pal = &kGreenCRTPalette;
  };

  static Canvas MakeCanvas(const RECT& clientRect, int themeMode = kCoreMonitorThemeMode) {
    const ThemePalette& pal = GetPalette(themeMode);
    ...
    Canvas c;
    c.rect = RECT { left, top, left + w, top + h };
    c.scale = scale;
    c.pal = &pal;
    return c;
  }

  static const ThemePalette& P(const Canvas& c) { return *c.pal; }
  ...
  static void Win98Bevel(HDC dc, const RECT& r, bool sunken = true) {
    COLORREF hi = sunken ? RGB(128,128,128) : RGB(255,255,255);
    COLORREF lo = sunken ? RGB(255,255,255) : RGB(128,128,128);
    Line(dc, r.left, r.top, r.right - 1, r.top, hi);
    Line(dc, r.left, r.top, r.left, r.bottom - 1, hi);
    Line(dc, r.right - 1, r.top, r.right - 1, r.bottom - 1, lo);
    Line(dc, r.left, r.bottom - 1, r.right - 1, r.bottom - 1, lo);
  }

  static void Win98Button(HDC dc, const Canvas& c, int x, int y, int w, int h, const std::wstring& text, bool pressed = false) {
    RECT r = R(c, x, y, w, h);
    Fill(dc, r, c.pal->panel);
    Win98Bevel(dc, r, !pressed);
    if (pressed) {
      RECT inner = R(c, x + 2, y + 2, w - 4, h - 4);
      Win98Bevel(dc, inner, true);
    }
    Text(dc, R(c, x + 4, y + 2, w - 8, h - 4), text, nullptr, c.pal->textPrimary, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false);
  }
  ...
  static void Text(HDC dc, RECT rect, const std::wstring& text, HFONT font, COLORREF color, UINT format, bool glow = true) {
    ...
    if (glow) {
      RECT g1 = rect;
      OffsetRect(&g1, 1, 0);
      SetTextColor(dc, s_pal->glowSoft);
  ...
  static COLORREF SeverityColor(const std::wstring& text) {
    if (text.find(L"WARN") != std::wstring::npos || text.find(L"[W]") != std::wstring::npos) return s_pal->warn;
    if (text.find(L"ERROR") != std::wstring::npos || text.find(L"FAIL") != std::wstring::npos || text.find(L"[E]") != std::wstring::npos) return s_pal->error;
    return s_pal->green;
  }

  static void DrawPanelBevel(HDC dc, const Canvas& c, int x, int y, int w, int h) {
    RECT outer = R(c, x, y, w, h);
    Fill(dc, outer, s_pal->panel);
    Outline(dc, outer, s_pal->green3);
    Outline(dc, R(c, x + 1, y + 1, w - 2, h - 2), s_pal->green5);
  }
  ...
  static void DrawOuterFrame(HDC dc, const Canvas& c) {
    ...
    if (c.pal->useBezel) {
      ...
      Fill(dc, bezel, p.bezel);
      RECT bezelHi = R(c, 20, 12, 1498, 14);
      Fill(dc, bezelHi, p.bezelEdge);
      RECT bezelBot = R(c, 20, 998, 1498, 14);
      Fill(dc, bezelBot, p.bezelInner);
      RECT bezelEdge = R(c, 24, 16, 1490, 992);
      Fill(dc, bezelEdge, p.bezelEdge);
      RECT inner = R(c, 28, 20, 1482, 984);
      Fill(dc, inner, p.bezelInner);
      RECT screen = R(c, 32, 28, 1474, 964);
      Fill(dc, screen, p.black);
      Outline(dc, R(c, 44, 72, 1446, 870), p.green5);
      Line(dc, X(c, 50), Y(c, 76), X(c, 1486), Y(c, 76), p.green3, 1);
      Line(dc, X(c, 49), Y(c, 948), X(c, 1486), Y(c, 948), p.green5, 1);
      HPEN bezelPen = CreatePen(PS_SOLID, 1, p.bezelEdge);
      ...
      if (c.pal->useGlow) {
        HPEN innerGlow = CreatePen(PS_SOLID, 1, p.glow);
      ...
      RECT screen = R(c, 20, 12, 1498, 1000);
      Fill(dc, screen, p.panel);
      Outline(dc, screen, p.green3);
    }
    if (c.pal->useVignette) {
      DrawVignette(dc, c);
    }
  }
  ...
  static void DrawHeader(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx) {
    const auto& p = P(c);
    Text(dc, R(c, 66, 38, 340, 34), L"MONIX v0.8.7", ctx.fonts.title, p.greenBright, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, p.useGlow);
    Text(dc, R(c, 550, 36, 430, 30), L"*** MONIX CORE SYSTEM MONITOR ***", ctx.fonts.body, p.green2, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    Text(dc, R(c, 1097, 38, 140, 28), ClockText(), ctx.fonts.body, p.greenBright, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    const Snapshot& s = SnapshotOrDefault(ctx);
    const std::wstring sysText = s.uptimeSeconds > 0 ? L"UP " + Hms(s.uptimeSeconds) : L"SYSTEM";
    Text(dc, R(c, 1242, 38, 130, 28), sysText, ctx.fonts.smallText, p.green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    Text(dc, R(c, 1377, 38, 108, 28), L"[-] [ ] [X]", ctx.fonts.smallText, p.green2, DT_RIGHT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
  }
  ...
  static void DrawPanel(HDC dc, const Canvas& c, int x, int y, int w, int h, const std::wstring& title, HFONT font, bool center = false) {
    ...
    Fill(dc, rect, s_pal->panel);
    Outline(dc, rect, s_pal->green3);
    Outline(dc, R(c, x + 1, y + 1, w - 2, h - 2), s_pal->green5);
    HPEN glowPen = CreatePen(PS_SOLID, 1, s_pal->panelGlow);
    ...
    Text(dc, titleRect, title, font, s_pal->green, (center ? DT_CENTER : DT_LEFT) | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
  }
  ...
  static void DrawSidebar(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx) {
    ...
    for (int i = 0; i < kMenuCount; ++i) {
      ...
      if (i == active) {
        Fill(dc, row, s_pal->green);
        RECT glowRow = row;
        OffsetRect(&glowRow, 0, -1);
        Fill(dc, glowRow, s_pal->activeRowGlow);
        OffsetRect(&glowRow, 0, 2);
        Fill(dc, glowRow, s_pal->activeRowGlow);
        Text(dc, R(c, 60, y, 190, 25), L"> " + std::wstring(items[i]), ctx.fonts.body, s_pal->activeText, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false);
      } else {
        Text(dc, R(c, 60, y, 190, 25), L"> " + std::wstring(items[i]), ctx.fonts.body, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
      }
    }
    ...
    const std::array<std::wstring, 7> core {
      ...
      L"VERSION....0.8.7-dev",
      L"ARCH.......x64",
      L"THREADS...." + std::to_wstring(std::max(1, s.threadCount > 0 ? s.threadCount : 12)),
      L"HANDLES...." + std::to_wstring(std::max(0, s.handleCount > 0 ? s.handleCount : 31247))
    };
    for (int i = 0; i < static_cast<int>(core.size()); ++i) {
      TextLine(dc, c, 44, 420 + i * 20, 208, core[i], ctx.fonts.smallText, ctx.fonts.smallLineHeight, s_pal->green);
    }

    DrawPanel(dc, c, 36, 580, 230, 170, L"SYSTEM INFO", ctx.fonts.smallText);
    const std::wstring cpu = s.cpuBrand[0] ? Utf8ToWide(s.cpuBrand) : L"RYZEN 5 7000";
    const std::wstring gpu = s.gpuModel.empty() ? L"RTX 5060 Ti" : s.gpuModel;
    const double ramTotal = s.ramTotalBytes ? BytesToGb(s.ramTotalBytes) : 32.0;
    const int cpuCores = s.cpuCores > 0 ? s.cpuCores : 6;
    const int cpuThreads = s.cpuLogicalCpus > 0 ? s.cpuLogicalCpus : 12;
    const std::array<std::wstring, 6> info {
      L"OS.......WIN 11",
      L"CPU......" + ShortText(cpu, 16),
      L"CORES...." + std::to_wstring(cpuCores) + L"C/" + std::to_wstring(cpuThreads) + L"T",
      L"GPU......" + ShortText(gpu, 16),
      L"RAM......" + Fixed(ramTotal, 0) + L" GB",
      L"DRIVER..." + (s.gpuDriverVersion.empty() ? L"UNKNOWN" : ShortText(s.gpuDriverVersion, 13))
    };
    for (int i = 0; i < static_cast<int>(info.size()); ++i) {
      TextLine(dc, c, 44, 620 + i * 20, 208, info[i], ctx.fonts.smallText, ctx.fonts.smallLineHeight, s_pal->green2);
    }
  ...
  static void DrawMetricCard(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx,
    ...
    COLORREF valueColor = isPercentage ? ThresholdColor(valPct) : s_pal->green;
    ...
    TextLine(dc, c, x + 12, 263, 72, subLeft, ctx.fonts.smallText, ctx.fonts.smallLineHeight, s_pal->green);
    Text(dc, R(c, x + 86, 263, 80, 22), subRight, ctx.fonts.smallText, s_pal->green, DT_RIGHT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
  }
  ...
  static double PercentTextValue(const std::wstring& text) {
    try {
      ...
      // Non-numeric text in metric display; return 0 as safe fallback
      return 0.0;
    }
  }
  ...
  static void DrawOverview(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx) {
    ...
    if (cpu >= 85.0) ++critCount; else if (cpu >= 65.0) ++warnCount;
    if (ram >= 85.0) ++critCount; else if (ram >= 65.0) ++warnCount;
    if (gpu >= 85.0) ++critCount; else if (gpu >= 65.0) ++warnCount;
    if (diskPct >= 85.0) ++critCount; else if (diskPct >= 65.0) ++warnCount;
    RECT healthBar = R(c, 292, 86, 768, 22);
    Fill(dc, healthBar, critCount > 0 ? s_pal->healthCrit : warnCount > 0 ? s_pal->healthWarn : s_pal->healthOk);
    const std::wstring healthText = critCount > 0 ?
      L"  " + std::to_wstring(critCount) + L" CRITICAL   " + std::to_wstring(warnCount) + L" WARNING" :
      warnCount > 0 ?
      L"  " + std::to_wstring(warnCount) + L" WARNING   ALL SYSTEMS NOMINAL" :
      L"  ALL SYSTEMS NOMINAL";
    Text(dc, R(c, 292, 86, 768, 22), healthText,
      ctx.fonts.smallText, critCount > 0 ? s_pal->error : warnCount > 0 ? s_pal->warn : s_pal->greenBright,
      DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    DrawPanel(dc, c, 288, 110, 772, 426, L"SYSTEM OVERVIEW", ctx.fonts.body, true);
    Text(dc, R(c, 1020, 120, 50, 20), Fixed(refreshRate, 0) + L" Hz", ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    DrawMetricCard(dc, c, ctx, 300, L"CPU", Fixed(cpu, 0) + L"%", Fixed(cpuGhz, 2) + L"G", Fixed(cpuTemp, 0) + L" C", ctx.cpuHistory, 100.0, false, true);
    ...
    DrawMetricCard(dc, c, ctx, 680, L"GPU", Fixed(gpu, 0) + L"%", Fixed(gpuTemp, 0) + L" C", Fixed(vramUsed, 1) + L"G VRAM", ctx.gpuHistory, 100.0, false, true);
    DrawMetricCard(dc, c, ctx, 870, L"NETWORK", RateTextShort(s.netDownBytesPerSec, 42.8), L"DN " + RateTextShort(s.netDownBytesPerSec, 42.8), L"UP " + RateTextShort(s.netUpBytesPerSec, 8.3), ctx.netHistory, 70.0, false);
  ...
  static void DrawRightRail(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx) {
    DrawEventStream(dc, c, ctx, R(c, 1072, 110, 428, 312));
    DrawStatusPanel(dc, c, ctx, R(c, 1072, 428, 428, 166));
    DrawDiss_panel(dc, c, ctx, R(c, 1072, 600, 428, 148));
  }

  static void DrawPerformanceGraph(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& panel) {
    Fill(dc, panel, s_pal->panel);
    Outline(dc, panel, s_pal->green3);
    Outline(dc, Pad(panel, S(c,1), S(c,1), S(c,1), S(c,1)), s_pal->green5);
    Text(dc, RECT { panel.left + S(c, 6), panel.top + S(c, 6), panel.right - S(c, 6), panel.top + S(c, 30) },
      L"PERFORMANCE GRAPH (60s)", ctx.fonts.body, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    Fill(dc, plot, s_pal->chartBg);
    Outline(dc, plot, s_pal->green4);
    for (int i = 1; i < 7; ++i) {
      const int x = plot.left + (plot.right - plot.left) * i / 7;
      Line(dc, x, plot.top, x, plot.bottom, s_pal->green5, 1, PS_DOT);
    }
    for (int i = 1; i < 4; ++i) {
      const int y = plot.top + (plot.bottom - plot.top) * i / 4;
      Line(dc, plot.left, y, plot.right, y, s_pal->green5, 1, PS_DOT);
    }
    ...
    for (int i = 0; i < 5; ++i) {
      Text(dc, RECT { panel.left + S(c, 4), plot.top + (plot.bottom - plot.top) * i / 4 - S(c, 10), panel.left + S(c, 46), plot.top + (plot.bottom - plot.top) * i / 4 + S(c, 12) },
        labels[i], ctx.fonts.smallText, s_pal->green3, DT_RIGHT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    }
    ...
    for (int i = 0; i < 5; ++i) {
      ...
      Text(dc, RECT { tx, panel.bottom - S(c, 22), tx + S(c, 40), panel.bottom - S(c, 2) },
        timeLabels[i], ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    }

    DrawHistoryLine(dc, plot, ctx.cpuHistory, 100.0, s_pal->green, 0);
    DrawHistoryLine(dc, plot, ctx.gpuHistory, 100.0, s_pal->accent, 5);
    DrawHistoryLine(dc, plot, ctx.ramHistory, 100.0, s_pal->green2, 11);
    ...
    const std::array<COLORREF, 4> legendColors { s_pal->green, s_pal->accent, s_pal->green2, s_pal->green3 };
  ...
  static void DrawGeneratedLine(HDC dc, const RECT& plot, double basePct, int phase) {
    ...
    HPEN pen = CreatePen(PS_SOLID, 1, s_pal->green2);
    HGDIOBJ oldPen = SelectObject(dc, pen);
  ...
  static void DrawSegmentedBar(HDC dc, const Canvas& c, const RECT& rect, double pct, int segments) {
    ...
    for (int i = 0; i < segments; ++i) {
      ...
      if (i < filled) {
        COLORREF fill = (pct > 85.0 && i >= segments - 3) ? s_pal->warn : (i < filled - 1 ? s_pal->green : s_pal->greenBright);
        Fill(dc, seg, fill);
      } else {
        Fill(dc, seg, s_pal->green5);
      }
    }
  }
  ...
  static void DrawProcessTable(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& panel, int rows) {
    ...
    Text(dc, RECT { panel.left + S(c, 12), panel.top + S(c, 6), panel.right - S(c, 12), panel.top + S(c, 30) },
      L"TOP PROCESSES", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    const int y0 = panel.top + S(c, 34);
    Text(dc, RECT { panel.left + S(c, 18), y0, panel.right - S(c, 8), y0 + S(c, 22) },
      L"PID    PROCESS          CPU%   RAM      GPU%   STATUS", ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    Line(dc, panel.left + S(c, 14), y0 + S(c, 25), panel.right - S(c, 14), y0 + S(c, 25), s_pal->green5, 1, PS_DOT);
    ...
    for (int i = 0; i < rows && i < static_cast<int>(processes.size()); ++i) {
      ...
      COLORREF bgColor = (i % 2 == 0) ? s_pal->panel : s_pal->panelSoft;
      ...
      COLORREF statusColor = s_pal->green;
      if (p.cpuPct > 50.0) statusColor = s_pal->warn;
      if (p.cpuPct > 80.0) statusColor = s_pal->error;
    ...
    Text(dc, RECT { panel.right - S(c, 190), panel.bottom - S(c, 28), panel.right - S(c, 20), panel.bottom - S(c, 6) },
      L"VIEW ALL (ENTER)", ctx.fonts.smallText, s_pal->green, DT_RIGHT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
  }
  ...
  static void DrawGpuFramePanel(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& panel) {
    ...
    Text(dc, RECT { panel.left + S(c, 12), panel.top + S(c, 6), panel.right - S(c, 10), panel.top + S(c, 28) },
      L"GPU FRAME TIME", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    Text(dc, RECT { panel.left + S(c, 12), panel.top + S(c, 28), panel.right - S(c, 12), panel.top + S(c, 52) },
      Fixed(frame, 2) + L" ms", ctx.fonts.title, frameOk ? s_pal->green : s_pal->error, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    Text(dc, RECT { panel.left + S(c, 12), panel.top + S(c, 52), panel.right - S(c, 12), panel.top + S(c, 70) },
      ...
      ctx.fonts.smallText, frameOk ? s_pal->green3 : s_pal->warn, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    RECT graph = { panel.left + S(c, 12), panel.top + S(c, 72), panel.right - S(c, 12), panel.bottom - S(c, 16) };
    Fill(dc, graph, s_pal->chartBg);
    Outline(dc, graph, s_pal->green4);
    ...
    Text(dc, RECT { panel.right - S(c, 80), graph.top - S(c, 6), panel.right - S(c, 12), graph.top + S(c, 12) },
      Fixed(maxFrameMs, 1) + L"ms", ctx.fonts.smallText, s_pal->green3, DT_RIGHT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
  }
  ...
  static void DrawMemoryPanel(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& panel) {
    ...
    Text(dc, RECT { panel.left + S(c, 12), panel.top + S(c, 5), panel.right - S(c, 12), panel.top + S(c, 28) },
      L"MEMORY USAGE", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    Text(dc, RECT { panel.left + S(c, 12), panel.top + S(c, 31), panel.right - S(c, 12), panel.top + S(c, 54) },
      Fixed(used, 1) + L"/" + Fixed(total, 0) + L"GB " + Fixed(pct, 0) + L"%", ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX | DT_END_ELLIPSIS);
  ...
  static void DrawEventStream(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& panel) {
    Fill(dc, panel, s_pal->panel);
    Outline(dc, panel, s_pal->green3);
    Outline(dc, Pad(panel, S(c,2), S(c,2), S(c,2), S(c,2)), s_pal->green5);
    Text(dc, RECT { panel.left + S(c, 12), panel.top + S(c, 8), panel.right - S(c, 12), panel.top + S(c, 34) },
      ctx.livePaused ? L"EVENT STREAM [PAUSED]" : L"EVENT STREAM [LIVE]", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    Text(dc, RECT { panel.left + S(c, 12), panel.bottom - S(c, 28), panel.right - S(c, 12), panel.bottom - S(c, 8) },
      L"VIEW ALL (ENTER)", ctx.fonts.smallText, s_pal->green3, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
  }
  ...
  static void DrawStatusPanel(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& panel) {
    ...
    Text(dc, RECT { panel.left + S(c, 14), panel.top + S(c, 6), panel.right - S(c, 12), panel.top + S(c, 30) },
      L"SYSTEM STATUS", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    const Snapshot& s = SnapshotOrDefault(ctx);
    ...
    const std::array<SubStatus, 6> subs {{
      { L"CPU",     cpuPct,  Fixed(cpuPct, 0) + L"%  " + Fixed(s.cpuCoreTempC > 0.0 ? s.cpuCoreTempC : 0.0, 0) + L"C" },
    ...
    for (int i = 0; i < static_cast<int>(subs.size()); ++i) {
      ...
      COLORREF color = crit ? s_pal->error : warn ? s_pal->warn : s_pal->green2;
      ...
      Text(dc, RECT { panel.left + S(c, 190), panel.top + S(c, 34 + i * 22), panel.right - S(c, 12), panel.top + S(c, 56 + i * 22) },
        subs[i].detail, ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX | DT_END_ELLIPSIS);
    }
  }

  static void DrawDiss_panel(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& panel) {
    Fill(dc, panel, s_pal->panel);
    Outline(dc, panel, s_pal->green3);
    Outline(dc, Pad(panel, S(c,2), S(c,2), S(c,2), S(c,2)), s_pal->green5);
    Text(dc, RECT { panel.left + S(c, 14), panel.top + S(c, 6), panel.right - S(c, 12), panel.top + S(c, 30) },
      L"DISK USAGE", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    const Snapshot& s = SnapshotOrDefault(ctx);
    const double diskPct = s.diskPctUsed > 0.0 ? s.diskPctUsed : 48.0;
    ...
    for (int i = 0; i < 3; ++i) {
      ...
      Text(dc, RECT { panel.left + S(c, 16), y, panel.left + S(c, 220), y + S(c, 22) }, labels[i], ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX | DT_END_ELLIPSIS);
  ...
  static void DrawLogPanel(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx) {
    ...
    Outline(dc, panel, s_pal->green3);
    Outline(dc, Pad(panel, S(c,1), S(c,1), S(c,1), S(c,1)), s_pal->green5);
    Text(dc, R(c, 292, 770, 180, 24), L"LOGS [ALL]", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    Text(dc, R(c, 1210, 770, 180, 24), L"(F1=DEBUG) (F5=CLEAR)", ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    Line(dc, X(c, 292), Y(c, 789), X(c, 1210), Y(c, 789), s_pal->green5, 1, PS_DOT);
    RECT infoBar = R(c, 1220, 773, 80, 16);
    RECT warnBar = R(c, 1308, 773, 50, 16);
    RECT errBar = R(c, 1366, 773, 40, 16);
    if (infoCount > 0) { Fill(dc, infoBar, RGB(0, 28, 6)); Text(dc, infoBar, L"I:" + std::to_wstring(infoCount), ctx.fonts.smallText, s_pal->green2, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false); }
    if (warnCount > 0) { Fill(dc, warnBar, RGB(30, 28, 4)); Text(dc, warnBar, L"W:" + std::to_wstring(warnCount), ctx.fonts.smallText, s_pal->warn, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false); }
    if (errCount > 0) { Fill(dc, errBar, RGB(30, 8, 4)); Text(dc, errBar, L"E:" + std::to_wstring(errCount), ctx.fonts.smallText, s_pal->error, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false); }
    for (int i = 0; i < static_cast<int>(rows.size()); ++i) {
      COLORREF color = SeverityColor(rows[i]);
  ...
  static void DrawFooter(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx) {
    ...
    Fill(dc, footer, s_pal->panel);
    Outline(dc, footer, s_pal->green4);
    const Snapshot& s = SnapshotOrDefault(ctx);
    ...
    const std::array<std::wstring, 7> cells {
      ...
      L"WARN: " + FixedWidthNumber(warnings, 3),
      L"ERR: " + FixedWidthNumber(errors, 3),
      L"DISK " + RateTextShort(s.diskReadBytesPerSec, 0.0) + L"/" + RateTextShort(s.diskWriteBytesPerSec, 0.0),
      L"FRAMES " + std::to_wstring(ctx.frameCount),
      L"READY"
    };
    const std::array<int, 8> stops { 48, 248, 448, 618, 768, 978, 1208, 1486 };
    for (int i = 1; i < static_cast<int>(stops.size()) - 1; ++i) {
      Line(dc, X(c, stops[i]), footer.top, X(c, stops[i]), footer.bottom, s_pal->green5, 1);
    }
    for (int i = 0; i < static_cast<int>(cells.size()); ++i) {
      COLORREF cellColor = s_pal->green2;
      if (i == 4) cellColor = s_pal->green;
      if (i == 6 && errors == 0) cellColor = s_pal->greenBright;
  ...
  static void DrawTaskManagerPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    Text(dc, Pad(summaryBar, S(c, 6), 0, S(c, 6), 0),
      ...
      ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
  ...
  static void DrawSectionPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx) {
    ...
    Fill(dc, main, s_pal->panel);
    Outline(dc, main, s_pal->green3);
    Outline(dc, Pad(main, S(c,1), S(c,1), S(c,1), S(c,1)), s_pal->green5);
    Text(dc, RECT { main.left + S(c, 12), main.top + S(c, 8), main.right - S(c, 12), main.top + S(c, 36) },
      titles[index], ctx.fonts.body, s_pal->green, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    if (index > 0) {
      Text(dc, RECT { main.left + S(c, 20), main.top + S(c, 36), main.right - S(c, 20), main.top + S(c, 52) },
        subtitles[index], ctx.fonts.smallText, s_pal->green3, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
      Line(dc, main.left + S(c, 30), main.top + S(c, 54), main.right - S(c, 30), main.top + S(c, 54), s_pal->green4, 1, PS_DOT);
    }
  ...
  static void DrawLogRowsPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    Text(dc, { main.left + S(c, 20), main.top + S(c, 54), main.right - S(c, 20), main.top + S(c, 80) },
      ...
      ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    Text(dc, infoBadge, L"I: " + std::to_wstring(infoCount), ctx.fonts.smallText, s_pal->green2, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false);
    if (warnCount > 0) { Fill(dc, warnBadge, RGB(30, 26, 4)); Text(dc, warnBadge, L"W: " + std::to_wstring(warnCount), ctx.fonts.smallText, s_pal->warn, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false); }
    if (errCount > 0) { Fill(dc, errBadge, RGB(30, 8, 4)); Text(dc, errBadge, L"E: " + std::to_wstring(errCount), ctx.fonts.smallText, s_pal->error, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false); }
    Line(dc, main.left + S(c, 16), main.top + S(c, 82), main.right - S(c, 16), main.top + S(c, 82), s_pal->green5, 1, PS_DOT);
    ...
    if (static_cast<int>(rows.size()) >= 24) {
      Text(dc, RECT { main.right - S(c, 120), main.bottom - S(c, 20), main.right - S(c, 18), main.bottom - S(c, 4) },
        L"SCROLL FOR MORE", ctx.fonts.smallText, s_pal->green4, DT_RIGHT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    }
  }
  ...
  static void DrawEventRowsPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    Fill(dc, filterBar, RGB(3, 18, 5));
    Text(dc, { main.left + S(c, 20), main.top + S(c, 54), main.right - S(c, 20), main.top + S(c, 80) },
      L"EVENTS: " + std::to_wstring(rows.size()), ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    Fill(dc, iB, RGB(0, 24, 6)); Text(dc, iB, L"I:" + std::to_wstring(infoC), ctx.fonts.smallText, s_pal->green2, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false);
    if (warnC > 0) { Fill(dc, wB, RGB(30, 26, 4)); Text(dc, wB, L"W:" + std::to_wstring(warnC), ctx.fonts.smallText, s_pal->warn, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false); }
    if (errC > 0) { Fill(dc, eB, RGB(30, 8, 4)); Text(dc, eB, L"E:" + std::to_wstring(errC), ctx.fonts.smallText, s_pal->error, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false); }
    Fill(dc, dB, RGB(4, 20, 8)); Text(dc, dB, L"D:" + std::to_wstring(debugC), ctx.fonts.smallText, s_pal->green4, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX, false);
    Line(dc, main.left + S(c, 16), main.top + S(c, 82), main.right - S(c, 16), main.top + S(c, 82), s_pal->green5, 1, PS_DOT);
    int y = main.top + S(c, 90);
    for (int i = 0; i < static_cast<int>(rows.size()); ++i) {
      COLORREF bgColor = (i % 2 == 0) ? s_pal->panel : s_pal->panelSoft;
  ...
  static COLORREF ThresholdColor(double pct) {
    if (pct >= 85.0) return s_pal->error;
    if (pct >= 65.0) return s_pal->warn;
    return s_pal->green;
  }
  ...
  static void DrawUsagePage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    const double netDown = s.netDownBytesPerSec ? std::min(100.0, static_cast<double>(s.netDownBytesPerSec) / (1024.0 * 1024.0) * 2.0) : 42.8;
    ...
    for (const auto& row : rows) {
      ...
      Text(dc, RECT { main.right - S(c, 56), y, main.right - S(c, 4), y + S(c, 28) },
        UsageStatus(row.second), ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
      y += S(c, 48);
    }
    Line(dc, main.left + S(c, 28), y, main.right - S(c, 28), y, s_pal->green5, 1, PS_DOT);
    y += S(c, 12);
    ...
    const std::wstring netUp = L"NET UPLINK...." + RateText(s.netUpBytesPerSec, 8.3);
    const std::wstring netDownStr = L"NET DOWNLINK.." + RateText(s.netDownBytesPerSec, 42.8);
    ...
    for (const auto& d : details) {
      Text(dc, RECT { main.left + S(c, 28), y, main.right - S(c, 28), y + S(c, 24) },
        d, ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX | DT_END_ELLIPSIS);
      y += S(c, 24);
  ...
  static void DrawSecurityPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    std::vector<SecRow> rows {
      ...
      { L"SELF HASH................", s.selfHashComputed == 0 ? L"[ FAIL ]" : s.selfHashComputed < 0 ? L"[UNKNOWN]" : L"[ OK ]", 0 },
    ...
    Text(dc, { main.left + S(c, 38), main.top + S(c, 54), main.right - S(c, 38), main.top + S(c, 82) },
      ...
      ctx.fonts.smallText, failCount > 0 ? s_pal->error : s_pal->green, DT_CENTER | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    for (int i = 0; i < static_cast<int>(rows.size()); ++i) {
      if (rows[i].section != prevSection) {
        if (prevSection >= 0) {
          Line(dc, main.left + S(c, 36), y - S(c, 4), main.right - S(c, 36), y - S(c, 4), s_pal->green5, 1, PS_DOT);
          y += S(c, 4);
        }
        Text(dc, RECT { main.left + S(c, 36), y, main.right - S(c, 36), y + S(c, 20) },
          sectionNames[rows[i].section], ctx.fonts.smallText, s_pal->green4, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
        y += S(c, 22);
        prevSection = rows[i].section;
      }
      COLORREF color = s_pal->green2;
      if (rows[i].value.find(L"FAIL") != std::wstring::npos) color = s_pal->error;
      else if (rows[i].value.find(L"WARN") != std::wstring::npos) color = s_pal->warn;
      else if (rows[i].value.find(L"OK") != std::wstring::npos) color = s_pal->green;
  ...
  static void DrawShadersPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    const std::array<std::wstring, 7> gpuRows {
      L"ACTIVE PRESET..........." + (ctx.shaderName.empty() ? L"DEFAULT" : ShortText(ctx.shaderName, 28)),
    ...
    for (int i = 0; i < static_cast<int>(gpuRows.size()); ++i) {
      Text(dc, RECT { main.left + S(c, 38), y, main.right - S(c, 38), y + S(c, 28) },
        gpuRows[i], ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX | DT_END_ELLIPSIS);
      y += S(c, 34);
    }
    y += S(c, 4);
    DrawSegmentedBar(dc, c, RECT { main.left + S(c, 38), y, main.right - S(c, 38), y + S(c, 14) }, vramPct, 40);
    y += S(c, 22);
    Line(dc, main.left + S(c, 36), y, main.right - S(c, 36), y, s_pal->green5, 1, PS_DOT);
    y += S(c, 12);
    Text(dc, RECT { main.left + S(c, 38), y, main.right - S(c, 38), y + S(c, 24) },
      L"SHADER PIPELINE STATUS", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    y += S(c, 28);
    ...
    for (const auto& p : pipelines) {
      Text(dc, RECT { main.left + S(c, 52), y, main.left + S(c, 340), y + S(c, 22) },
        p.first, ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
      Text(dc, RECT { main.left + S(c, 360), y, main.right - S(c, 38), y + S(c, 22) },
        p.second, ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
      y += S(c, 24);
      if (y > main.bottom - S(c, 18)) break;
    }
  }
  ...
  static void DrawNetworkPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    const double downMB = s.netDownBytesPerSec > 0 ? static_cast<double>(s.netDownBytesPerSec) / (1024.0 * 1024.0) : 42.8;
    const double upMB = s.netUpBytesPerSec > 0 ? static_cast<double>(s.netUpBytesPerSec) / (1024.0 * 1024.0) : 8.3;
    ...
    Text(dc, RECT { main.left + S(c, 36), main.top + S(c, 64), main.right - S(c, 36), main.top + S(c, 90) },
      L"NETWORK ACTIVITY", ctx.fonts.smallText, s_pal->green, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    Text(dc, RECT { main.left + S(c, 36), main.top + S(c, 92), main.left + S(c, 200), main.top + S(c, 112) },
      L"DOWNLINK", ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    ...
    Text(dc, RECT { main.left + S(c, 36), main.top + S(c, 114), main.left + S(c, 200), main.top + S(c, 134) },
      L"UPLINK", ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    DrawSegmentedBar(dc, c, RECT { main.left + S(c, 210), main.top + S(c, 117), main.right - S(c, 38), main.top + S(c, 131) }, upPct, 30);
    Line(dc, main.left + S(c, 34), main.top + S(c, 144), main.right - S(c, 34), main.top + S(c, 144), s_pal->green5, 1, PS_DOT);
    ...
    Text(dc, RECT { main.left + S(c, 36), y, main.right - S(c, 36), y + S(c, 20) },
      L"PROCESS          CONN  REMOTE              STATE", ctx.fonts.smallText, s_pal->green3, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
    y += S(c, 26);
    for (int i = 0; i < static_cast<int>(flows.size()); ++i) {
      ...
      Text(dc, RECT { main.left + S(c, 38), y, main.right - S(c, 38), y + S(c, 22) },
        row.str(), ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
      y += S(c, 24);
  ...
  static std::wstring ThemeName(int themeMode) {
    switch (themeMode) {
      ...
      case kModernThemeMode: return L"MODERN";
  ...
  static void DrawSettingsPage(HDC dc, const Canvas& c, const CoreMonitorThemeContext& ctx, const RECT& main) {
    ...
    const std::vector<SettingRow> rows {
      ...
      { L"SHADER", ctx.shaderName.empty() ? L"crt-geom" : ShortText(ctx.shaderName, 24), 0 },
      { L"DISPLAY", s.displayWidth > 0 ? std::to_wstring(s.displayWidth) + L"x" + std::to_wstring(s.displayHeight) + L" " + std::to_wstring(s.displayRefreshRateHz) + L"Hz" : L"1920x1080 60Hz", 1 },
      { L"RESOLUTION", s.displayWidth > 0 ? std::to_wstring(s.displayWidth) + L" x " + std::to_wstring(s.displayHeight) : L"1920 x 1080", 1 },
      { L"REFRESH RATE", s.displayRefreshRateHz > 0 ? std::to_wstring(s.displayRefreshRateHz) + L" Hz" : L"60 Hz", 1 },
    ...
    for (int i = 0; i < static_cast<int>(rows.size()); ++i) {
      if (rows[i].group != prevGroup) {
        ...
        Text(dc, RECT { main.left + S(c, 36), y, main.right - S(c, 36), y + S(c, 20) },
          groupNames[rows[i].group], ctx.fonts.smallText, s_pal->green4, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX);
        y += S(c, 24);
        prevGroup = rows[i].group;
      }
      RECT row = { main.left + S(c, 36), y, main.right - S(c, 36), y + S(c, 28) };
      Fill(dc, row, RGB(3, 18, 5));
      Outline(dc, row, s_pal->green4);
      Text(dc, RECT { row.left + S(c, 12), row.top, row.left + S(c, 220), row.bottom },
        std::wstring(rows[i].label) + L"................", ctx.fonts.smallText, s_pal->green2, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX | DT_END_ELLIPSIS);
      Text(dc, RECT { row.left + S(c, 240), row.top, row.right - S(c, 12), row.bottom },
        rows[i].value, ctx.fonts.smallText, s_pal->green, DT_RIGHT | DT_VCENTER | DT_SINGLELINE | DT_NOPREFIX | DT_END_ELLIPSIS);
      y += S(c, 34);
      if (y > main.bottom - S(c, 18)) break;
    }
  }
