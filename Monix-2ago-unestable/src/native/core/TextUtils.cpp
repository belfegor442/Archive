...
std::wstring FormatClockNow(bool includeMilliseconds) {
  ...
  if (includeMilliseconds) {
    swprintf(buffer, 48, L"%02d/%02d %02d:%02d:%02d.%03d", time.wMonth, time.wDay, time.wHour, time.wMinute, time.wSecond, time.wMilliseconds);
  } else {
    swprintf(buffer, 48, L"%02d/%02d %02d:%02d:%02d", time.wMonth, time.wDay, time.wHour, time.wMinute, time.wSecond);
  }
  return buffer;
}
...
COLORREF ResolveColor(ColorRole role) {
  switch (role) {
    case ColorRole::Black: return RGB(2, 4, 2);
    case ColorRole::Primary: return RGB(0, 230, 118);
    case ColorRole::Success: return RGB(76, 232, 136);
    case ColorRole::Warning: return RGB(255, 190, 24);
    case ColorRole::Error: return RGB(240, 82, 68);
    case ColorRole::Network: return RGB(64, 200, 255);
    case ColorRole::Scram: return RGB(232, 222, 196);
    case ColorRole::Kernel: return RGB(255, 190, 24);
    case ColorRole::Dim: return RGB(88, 120, 88);
    case ColorRole::Accent: return RGB(18, 64, 28);
    case ColorRole::Inverse: return RGB(4, 8, 4);
    case ColorRole::Idle: return RGB(24, 32, 24);
    case ColorRole::Engine: return RGB(64, 200, 255);
    case ColorRole::Security: return RGB(210, 190, 140);
    case ColorRole::HealthScore: return RGB(140, 245, 110);
    case ColorRole::Storage: return RGB(200, 178, 132);
    case ColorRole::CriticalScram: return RGB(255, 188, 108);
    case ColorRole::UserInput: return RGB(170, 224, 255);
    case ColorRole::Fatal: return RGB(120, 28, 18);
    case ColorRole::Thermal: return RGB(255, 190, 24);
    case ColorRole::White:
    default:
      return RGB(220, 214, 194);
  }
}

COLORREF ResolveGlowColor(ColorRole role) {
  switch (role) {
    case ColorRole::Warning: return RGB(60, 38, 0);
    case ColorRole::Error: return RGB(64, 12, 8);
    case ColorRole::Network: return RGB(6, 28, 38);
    case ColorRole::Scram: return RGB(36, 28, 14);
    case ColorRole::Kernel: return RGB(54, 28, 0);
    case ColorRole::Dim: return RGB(8, 22, 10);
    case ColorRole::Idle: return RGB(6, 8, 6);
    case ColorRole::Engine: return RGB(6, 28, 38);
    case ColorRole::Security: return RGB(28, 22, 14);
    case ColorRole::HealthScore: return RGB(14, 36, 14);
    case ColorRole::Storage: return RGB(32, 24, 14);
    case ColorRole::CriticalScram: return RGB(54, 34, 8);
    case ColorRole::UserInput: return RGB(8, 28, 38);
    case ColorRole::Fatal: return RGB(32, 6, 4);
    case ColorRole::Thermal: return RGB(54, 28, 0);
