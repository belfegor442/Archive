...
cl.exe /MT /std:c++20 /O2 /Zm800 /bigobj /EHsc /utf-8 /DUNICODE /D_UNICODE /w /I"$root\login" /I"$root\sensors" /I"$root\src\native\renderer_vk" /c "$source" /Fo:"$objOutput"
if errorlevel 1 goto :error
...
cl.exe /MT /std:c++20 /O2 /Zm800 /bigobj /EHsc /utf-8 /DUNICODE /D_UNICODE /I"$root\src\native" /I"$root\login" /I"$root\sensors" /I"$root\src\native\renderer_vk" /c "$monixAppSource" /Fo:"$monixAppObjOutput"
if errorlevel 1 goto :error
