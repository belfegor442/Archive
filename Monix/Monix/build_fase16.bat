...
cl.exe /MT /std:c++20 /Od /EHsc /bigobj /F33554432 ^
  ...
  src\native\fase16_test_unity.cpp ^
  src\native\renderer_vk\library\tests\fase16_workspace_tests_main.cpp ^
  /Febuild\fase16_workspace_tests.exe

echo ERRORLEVEL=%ERRORLEVEL%
dir build\fase16_workspace_tests.exe 2>nul
