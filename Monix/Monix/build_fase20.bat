...
echo Building fase20_gdi_shader_ui_tests...
cl.exe /MT /std:c++20 /Od /EHsc /bigobj /F33554432 ^
  ...
  src\native\fase20_test_unity.cpp ^
  src\native\renderer_vk\library\tests\fase20_gdi_shader_ui_tests_main.cpp ^
  /Febuild\fase20_gdi_shader_ui_tests.exe
