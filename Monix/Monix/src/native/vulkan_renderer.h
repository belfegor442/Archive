...
// ============================================================================
struct PipelineKey {
    uint32_t vertModuleHash = 0;
    uint32_t fragModuleHash = 0;
...
// ============================================================================
// Forward declaration for decomposition modules
// ============================================================================
struct VkCtx;
namespace vk_swap {
...
class VulkanRenderer {
    friend struct VkCtx;
    friend bool vk_swap::createSurface(VkCtx&, HWND);
    friend bool vk_swap::createSwapchain(VkCtx&, uint32_t, uint32_t);
    friend void vk_swap::destroySwapchain(VkCtx&);
    friend void vk_swap::resize(VkCtx&, uint32_t, uint32_t);
public:
    VulkanRenderer();
    ~VulkanRenderer();
