...
struct Snapshot {
  ...
  uint64_t previousContextSwitches = 0;
  uint64_t previousInterruptCount = 0;
  uint64_t previousDpcCount = 0;
  uint64_t previousIsrCount = 0;
